...
def train_rf():
    ...
    if 'ai_suggested_params' in st.session_state:
        ...
        default_max_depth = suggested.get('max_depth', 10)
        default_min_samples_split = suggested.get('min_samples_split', 2)
        default_min_samples_leaf = suggested.get('min_samples_leaf', 1)
